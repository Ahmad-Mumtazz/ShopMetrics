...
export default function AuthPage() {
  ...
  return (
    <div data-theme={theme} className="auth-screen flex items-center justify-center p-4">
      ...
      <button type="button" onClick={toggleTheme} className="theme-toggle theme-toggle--auth bulb-button" aria-label={`Theme (currently ${theme})`} title="Theme">{theme === 'dark' ? '☀' : '☾'}</button>
